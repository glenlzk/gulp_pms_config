...
(function(factory) {
    ...
    Vue.component('mz-datepicker', {
        ...
        '<input :value="value" class="form-control input-sm w200" readonly :disabled="disabled" :class="{focus:show}" @click="click" @mousedown="$event.preventDefault()" /><a v-if="clearable&&value" @click.stop="clear"></a><i @click="click"></i>' +	/* @blur="show = false" */
