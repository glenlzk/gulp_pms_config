...
$(function () {
	...
	;(function (window, document, $, yzl) {
        ...
        globalObject = {
            ...
            isHasFlash: true,
			errorImgUrl: './images/index/acconut_icon-142b44b1f7.png',
			errorPersonImgUrl: './images/index/acconutPerson_icon-a23dc1bd30.png',
...
//	                 'hideButton': true,
			...
			*/
			showLoadingTips: function (params) {
				...
				if (tips) {
                    loading = $('<div><img style="margin:0 auto;"src="images/index/loading2-f8e91f3fed.gif" alt=""/><p style="text-align: center;font-size: 12px;background:transparent;">加载中...请稍后</p></div>');
				} else {
                    loading = $('<div><img style="margin:0 auto;"src="images/index/loading2-f8e91f3fed.gif" alt=""/></div>');
				};
	...
	;(function (window, document, $, yzl) {
		...
		$('.header .nav li a').click(function () {
			...
			if($(this).html() == '首页'){
					$('.content').css('background','#fff url(images/index/index-bg-b6e0578fab.png) no-repeat center bottom');
				}else{
					$('.content').css('background','url(images/index/body_bg-aa02b22818.jpg) no-repeat center top');
				}
		});
